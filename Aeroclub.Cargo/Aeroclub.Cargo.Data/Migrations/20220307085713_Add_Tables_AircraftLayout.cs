...
{
    public partial class Add_Tables_AircraftLayout : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AircraftDeckType = table.Column<short>(type: "smallint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AircraftDecks", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LoadPlanStatus = table.Column<byte>(type: "tinyint", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CargoPositions", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ULDContainers", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AircraftDecks_AircraftLayoutId",
                table: "AircraftDecks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ULDContainers_LoadPlanId",
                table: "ULDContainers",
                column: "LoadPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_ULDContainers_ULDId",
                table: "ULDContainers",
                column: "ULDId");
