...
namespace Aeroclub.Cargo.Application.Interfaces
{
    public interface IBookingManagerService
    {
        ...
        Task<IReadOnlyList<CargoBookingStandByCargoVM>> GetBookingByPackageStatus(PackageItemStatus type);
        ...
        Task<LocationsByAWBVM> GetLocationsByAWBAsync(GetAirportsRM query);
