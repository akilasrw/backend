...
namespace Aeroclub.Cargo.Application.Specifications
{
    public class FlightScheduleSpecification : BaseSpecification<FlightSchedule>
    {
        ...
        : base(x=> 
            ...
            (query.FlightFromDate == DateTime.MinValue || x.ScheduledDepartureDateTime.AddMinutes(-x.CutoffTimeMin) >= query.FlightFromDate) &&
        ...
        public FlightScheduleSpecification(DateTime date, Guid flightId)
        : base(x => x.ScheduledDepartureDateTime.Date == date.Date && x.FlightId == flightId && x.IsDeleted == false){ }
